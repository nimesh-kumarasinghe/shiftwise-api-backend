...
namespace ShiftWiseAI.Server.Migrations
{
    ...
    [Migration("20250620141207_AddIsInformedToShift")]
    partial class AddIsInformedToShift
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftWiseAI.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShiftWiseAI.Server.Models.ApplicationUser", null)
                        .WithMany()
